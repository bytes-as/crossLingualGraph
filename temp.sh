...
cd $ROOT/deepwalk
$PYTHON -m deepwalk --input $EXP_DIR/english_$FREQ1/graph_int_${FREQ1}.english --format edgelist --walks-output $EXP_DIR/english_$FREQ1/english_int_${FREQ1}.walks --workers 30 --number-walks $NUM_WALKS1

$PYTHON -m deepwalk --input $EXP_DIR/hindi_$FREQ2/graph_int_${FREQ2}.hindi --format edgelist --walks-output $EXP_DIR/hindi_$FREQ2/hindi_int_${FREQ2}.walks --workers 30 --number-walks $NUM_WALKS2
cd $ROOT
